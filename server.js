...
server.get("/", function (req, res) {
  const about = {
    ...
    description:
      'Programador full-stack, focado em trazer o melhor ensino para inciantes em programação. Colaborador da <a href="https://rocketseat.com.br" target="_blank">Rocketseat</a>',
    links: [
